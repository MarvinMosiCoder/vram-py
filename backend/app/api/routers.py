...
from app.api.admin import auth, dashboard, sidebar, admin, editor, profile, system, chat, changepassword, memecoin
...
router.include_router(changepassword.router)
router.include_router(memecoin.router)
