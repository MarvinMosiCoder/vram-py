...
type AnnouncementsModalProps = {
    show: boolean;
    onClose?: (e: MouseEvent<HTMLButtonElement>, reason: "close") => void;
    children: ReactNode;
    title?: string | null;
    ...
    loading?: boolean;
    isDisabled?: boolean;
    // "dismiss" comes from the close button when no onClose is given.
    onClick?: (e: MouseEvent<HTMLButtonElement>, action: "dismiss" | "submit") => void;
    withButton?: boolean;
    currentIndex?: number;
    total?: number;
    isRead?: boolean;
