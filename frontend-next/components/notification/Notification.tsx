...
const Notification = ({ id, message, type = "General", onClick, isRead, created }: { id: number; message?: string | null; type?: string | null; onClick?: (id: number) => void; isRead: boolean | number; created?: string | null }) => {
  ...
  const timeDifference = (timestamp?: string | null) => {
  ...
  return (
    <Link
      href={id ? `/notifications/view-notification/${id}` : "/notifications"}
