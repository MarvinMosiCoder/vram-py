...
// typography plugin in this project (Tailwind v4, configured in globals.css).
...
// Imported only by the client Chat component, so it joins the /chat route's
// client chunk and needs no "use client" of its own.
