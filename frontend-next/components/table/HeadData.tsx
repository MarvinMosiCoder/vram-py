...
const HeadData = ({ children, sortable, sorted, direction, onSort, sticky, center, width }: { children: ReactNode; sortable?: boolean; sorted?: boolean; direction?: "asc" | "desc"; onSort?: () => void; sticky?: "left" | "right"; center?: boolean; width?: string }) => {
    const classes = [
    ...
    return (
        <th
            ...
            onKeyDown={sortable ? (event) => { if (event.key === "Enter" || event.key === " ") { event.preventDefault(); onSort?.(); } } : undefined}
