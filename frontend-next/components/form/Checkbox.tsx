...
const Checkbox = ({ checked, onChange, disabled, className = "", ...props }: Omit<InputHTMLAttributes<HTMLInputElement>, "checked" | "onChange"> & { checked?: unknown; onChange?: (value: number, event: ChangeEvent<HTMLInputElement>) => void }) => {
    return (
        <input
            type="checkbox"
